...
#include "tensorflow/core/lib/tif/tif_io.h"
...
// Decode the contents of a TIF file
class DecodeTifOp : public OpKernel {
 public:
  explicit DecodeTifOp(OpKernelConstruction* context) : OpKernel(context) {
